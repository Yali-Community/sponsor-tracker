...
2. Scan the QR or use the mobile UPI link, then enter your username and payment details. New users provide a name and can choose a pastel profile icon or upload an optional photo, with a live preview. Quick amount buttons fill ₹100, ₹500 or ₹1,000; custom amounts remain editable. Choose Instagram, X / Twitter, or a custom HTTPS link for an optional social profile. Existing usernames must match the verified email; their saved profile fields are reused.
