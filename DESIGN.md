...
The heart supplies the pink accent; deeper rose marks focus and selected portraits. Ink and muted text sit on ivory with pale dividers. Five pastel portrait backgrounds cycle through CSV order and do not encode contribution size.

## Typography

Use bundled Manrope, with weights 400–700. The total is the strongest type; amounts use tabular numerals. The page title is 25px and wall headline 24px. Supporting text ranges from 10–14px. Long names, notes, and transaction references wrap.
